...
class Course(models.Model):
    ...
    #This function returns all the questions for this course
    @property
...
class Lesson(models.Model):
    ...
    #This function returns all questions for this lesson
    @property
    def get_questions(self):
        return Question.objects.filter(lesson = self)
...
class Question(models.Model):
    ...
    mark = models.IntegerField(default=1) #grade/mark
    ...
    #This function returns all the choices for this question
    @property
